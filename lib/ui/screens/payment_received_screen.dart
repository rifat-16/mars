...
class _PaymentReceivedScreenState extends State<PaymentReceivedScreen> {
  ...
  Future<void> _refreshPayments() async {
    setState(() {
      _refreshFuture = _firestore.collection('payments').orderBy('timestamp', descending: true).get().then((_) {});
    });
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection('payments').orderBy('timestamp', descending: true).snapshots(),
